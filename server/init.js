...
const init = async () => {
    ...
    let q5 = await questionCreate('Best pizza in Boston?', 'Not technical but maybe someone has a good rec', [t7], [], u1, new Date('2023-04-14T21:17:53'), 20, -14, false); // post moderation test flag changes when vote_count < -15
